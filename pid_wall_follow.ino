...
//void pid_wall_follow_step(uint16_t tof_right_2, uint16_t tof_right_1, uint16_t tof_front, uint16_t tof_left_1, uint16_t tof_left_2){    

void pid_wall_follow_step(){    
